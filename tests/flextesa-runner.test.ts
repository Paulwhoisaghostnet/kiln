...
print(json.dumps({
  ...
  "typedPairCandidates": module.build_arg_candidates("some_entrypoint", "bert", [1], "pair nat nat string"),
...
describe('Flextesa shadowbox runner argument compatibility', () => {
  it('builds Michelson expressions for generated workflow entrypoint shapes', () => {
    ...
    expect(expressions.typedPairCandidates).toEqual([
      '1',
      '(Pair 1 1 "shadowbox")',
      '(Pair 1 (Pair 1 "shadowbox"))',
      'Unit',
