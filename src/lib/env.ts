...
const envSchema = z.object({
  ...
  TEZOS_CHAIN_ID: z.string().trim().min(1).optional(),
  WALLET_A_SECRET_KEY: z.string().trim().min(1).optional(),
  WALLET_B_SECRET_KEY: z.string().trim().min(1).optional(),
  KILN_DUMMY_TOKENS: z.string().trim().optional(),
